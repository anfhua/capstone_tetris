...
# Create a border
BORDER_THICKNESS = 2
LEFT_BORDER = (0, 0, HEIGHT)
RIGHT_BORDER = (WIDTH, 0, HEIGHT)
TOP_BORDER = (0, HEIGHT, WIDTH)
BOTTOM_BORDER = (0, 0, WIDTH)
...
def draw(self, screen):
   ...
   pygame.draw.lines(screen, BORDER_COLOR, False, [(LEFT_BORDER, RIGHT_BORDER), (TOP_BORDER, BOTTOM_BORDER)], BORDER_THICKNESS)
...
class Tetromino:
    def __init__(self, x, y, shape, shape_index):
       self.x = x
       self.y = y
       self.shape = shape
...
class Tetris:
    ...
    def new_piece(self):
        ...
        return Tetromino(self.width // 2, 0, shape, shape_index)
